...
<CellOutput>
{
`[INFO 09-09 19:40:08] ax.api.client: GenerationStrategy(name='Center+Sobol+MBM:fast', nodes=[CenterGenerationNode(next_node_name='Sobol'), GenerationNode(node_name='Sobol', generator_specs=[GeneratorSpec(generator_enum=Sobol, model_key_override=None)], transition_criteria=[MinTrials(transition_to='MBM'), MinTrials(transition_to='MBM')]), GenerationNode(node_name='MBM', generator_specs=[GeneratorSpec(generator_enum=BoTorch, model_key_override=None)], transition_criteria=[])]) chosen based on user input and problem structure.
[INFO 09-09 19:40:08] ax.api.client: Generated new trial 0 with parameters {'x1': 0.0, 'x2': 0.0} using GenerationNode CenterOfSearchSpace.
[INFO 09-09 19:40:08] ax.api.client: Trial 0 marked COMPLETED.
[INFO 09-09 19:40:08] ax.api.client: Generated new trial 1 with parameters {'x1': -2.693055, 'x2': -4.400393} using GenerationNode Sobol.
[INFO 09-09 19:40:08] ax.api.client: Trial 1 marked COMPLETED.
[INFO 09-09 19:40:08] ax.api.client: Generated new trial 2 with parameters {'x1': 6.7286, 'x2': 8.524181} using GenerationNode Sobol.
[INFO 09-09 19:40:08] ax.api.client: Trial 2 marked COMPLETED.
[INFO 09-09 19:40:08] ax.api.client: Generated new trial 3 with parameters {'x1': 4.851903, 'x2': -7.354188} using GenerationNode Sobol.
[INFO 09-09 19:40:08] ax.api.client: Trial 3 marked COMPLETED.
[INFO 09-09 19:40:08] ax.api.client: Generated new trial 4 with parameters {'x1': -5.801518, 'x2': 0.892658} using GenerationNode Sobol.
[INFO 09-09 19:40:08] ax.api.client: Trial 4 marked COMPLETED.
[INFO 09-09 19:40:08] ax.api.client: Generated new trial 5 with parameters {'x1': 1.665393, 'x2': 0.807231} using GenerationNode MBM.
[INFO 09-09 19:40:08] ax.api.client: Trial 5 marked COMPLETED.
[INFO 09-09 19:40:09] ax.api.client: Generated new trial 6 with parameters {'x1': 4.24734, 'x2': -0.501298} using GenerationNode MBM.
[INFO 09-09 19:40:09] ax.api.client: Trial 6 marked COMPLETED.
[INFO 09-09 19:40:09] ax.api.client: Generated new trial 7 with parameters {'x1': 3.578209, 'x2': 0.799449} using GenerationNode MBM.
[INFO 09-09 19:40:09] ax.api.client: Trial 7 marked COMPLETED.
[INFO 09-09 19:40:10] ax.api.client: Generated new trial 8 with parameters {'x1': 10.0, 'x2': -3.390286} using GenerationNode MBM.
[INFO 09-09 19:40:10] ax.api.client: Trial 8 marked COMPLETED.
[INFO 09-09 19:40:10] ax.api.client: Generated new trial 9 with parameters {'x1': 10.0, 'x2': -10.0} using GenerationNode MBM.
[INFO 09-09 19:40:10] ax.api.client: Trial 9 marked COMPLETED.`
}
</CellOutput>
...
<PlotlyFigure data={require('./assets/plot_data/e460204c-da2d-43d4-9ba8-eb540853c008.json')} />
...
<CellOutput>
{
`[INFO 09-09 19:40:14] ax.api.client: Generated new trial 10 with parameters {'x1': -10.0, 'x2': 10.0} using GenerationNode MBM.
[INFO 09-09 19:40:14] ax.api.client: Trial 10 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 09-09 19:40:15] ax.api.client: Generated new trial 11 with parameters {'x1': 2.875311, 'x2': 0.331451} using GenerationNode MBM.
[INFO 09-09 19:40:15] ax.api.client: Trial 11 marked FAILED.
[INFO 09-09 19:40:15] ax.api.client: Generated new trial 12 with parameters {'x1': 2.872289, 'x2': 0.310909} using GenerationNode MBM.
[INFO 09-09 19:40:15] ax.api.client: Trial 12 marked COMPLETED.
[INFO 09-09 19:40:16] ax.api.client: Generated new trial 13 with parameters {'x1': 1.60192, 'x2': 1.722365} using GenerationNode MBM.
[INFO 09-09 19:40:16] ax.api.client: Trial 13 marked COMPLETED.
[INFO 09-09 19:40:16] ax.api.client: Generated new trial 14 with parameters {'x1': -3.306728, 'x2': 6.949627} using GenerationNode MBM.
[INFO 09-09 19:40:16] ax.api.client: Trial 14 marked COMPLETED.
[INFO 09-09 19:40:17] ax.api.client: Generated new trial 15 with parameters {'x1': -0.813561, 'x2': 3.997224} using GenerationNode MBM.
[INFO 09-09 19:40:17] ax.api.client: Trial 15 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 09-09 19:40:18] ax.api.client: Generated new trial 16 with parameters {'x1': -5.825847, 'x2': 10.0} using GenerationNode MBM.
[INFO 09-09 19:40:18] ax.api.client: Trial 16 marked COMPLETED.
[INFO 09-09 19:40:18] ax.api.client: Generated new trial 17 with parameters {'x1': -2.240887, 'x2': 10.0} using GenerationNode MBM.
[INFO 09-09 19:40:18] ax.api.client: Trial 17 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 09-09 19:40:19] ax.api.client: Generated new trial 18 with parameters {'x1': 0.308278, 'x2': 2.960845} using GenerationNode MBM.
[INFO 09-09 19:40:19] ax.api.client: Trial 18 marked FAILED.
[INFO 09-09 19:40:19] ax.api.client: Generated new trial 19 with parameters {'x1': -10.0, 'x2': 7.797884} using GenerationNode MBM.
[INFO 09-09 19:40:19] ax.api.client: Trial 19 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.`
}
</CellOutput>
...
<PlotlyFigure data={require('./assets/plot_data/1e71b8d2-a6de-4990-9ab3-4d1afc3a52d7.json')} />
