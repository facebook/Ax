...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.5/tutorials/multi_task/multi_task.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.5/tutorials/multi_task/multi_task.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/b266a880-ce4e-459c-b001-0d3d2b556e73.json')} />
