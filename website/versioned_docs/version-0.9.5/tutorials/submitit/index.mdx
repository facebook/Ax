...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.5/tutorials/submitit/submitit.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.5/tutorials/submitit/submitit.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/af58e1b9-0299-41bf-8410-7f70891a5b08.json')} />
