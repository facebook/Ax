...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.5/tutorials/scheduler/scheduler.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.5/tutorials/scheduler/scheduler.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/c533a0cd-cee3-4872-8053-896e69008212.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/b9c8a8af-415a-4d31-91c0-54e6379d3098.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/67c05526-0219-4d98-ac13-31433fdf3a66.json')} />
