...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.5/tutorials/gpei_hartmann_service/gpei_hartmann_service.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.5/tutorials/gpei_hartmann_service/gpei_hartmann_service.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/22161b8a-d9c6-45ff-a5a0-48c3f1a813b6.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/6238e827-3698-4ecf-9c03-2c86cc9440c2.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/423a6ad9-360b-4349-96a3-28a1c1840f73.json')} />
