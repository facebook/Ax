...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.5/tutorials/tune_cnn_service/tune_cnn_service.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.5/tutorials/tune_cnn_service/tune_cnn_service.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/01571bba-c072-4eeb-bad4-cdb7b9025690.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/9f4868ef-dc25-4e78-8a9c-2ef92c942ca9.json')} />
