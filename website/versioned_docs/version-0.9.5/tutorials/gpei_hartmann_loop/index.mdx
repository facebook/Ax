...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.5/tutorials/gpei_hartmann_loop/gpei_hartmann_loop.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.5/tutorials/gpei_hartmann_loop/gpei_hartmann_loop.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/9e0dafce-fbfa-47fa-8203-dce608b7f900.json')} />

```python
render(plot_contour(model=model, param_x="x1", param_y="x2", metric_name="l2norm"))
```

<PlotlyFigure data={require('./assets/plot_data/b2b706c4-648d-4f5b-8c4b-fb351b0c7b4f.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/983ec861-5e3b-4e73-bb3d-6f6f0fd4752e.json')} />
