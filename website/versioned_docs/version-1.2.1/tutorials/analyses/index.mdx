...
<CellOutput>
{
`[INFO 11-21 20:41:04] ax.api.client: GenerationStrategy(name='Center+Sobol+MBM:fast', nodes=[CenterGenerationNode(next_node_name='Sobol'), GenerationNode(name='Sobol', generator_specs=[GeneratorSpec(generator_enum=Sobol, model_key_override=None)], transition_criteria=[MinTrials(transition_to='MBM'), MinTrials(transition_to='MBM')]), GenerationNode(name='MBM', generator_specs=[GeneratorSpec(generator_enum=BoTorch, model_key_override=None)], transition_criteria=[])]) chosen based on user input and problem structure.
[INFO 11-21 20:41:04] ax.api.client: Generated new trial 0 with parameters {'x1': 0.0, 'x2': 0.0} using GenerationNode CenterOfSearchSpace.
[INFO 11-21 20:41:04] ax.api.client: Trial 0 marked COMPLETED.
[INFO 11-21 20:41:04] ax.api.client: Generated new trial 1 with parameters {'x1': -2.622138, 'x2': -8.285331} using GenerationNode Sobol.
[INFO 11-21 20:41:04] ax.api.client: Trial 1 marked COMPLETED.
[INFO 11-21 20:41:04] ax.api.client: Generated new trial 2 with parameters {'x1': 0.808671, 'x2': 0.451619} using GenerationNode Sobol.
[INFO 11-21 20:41:04] ax.api.client: Trial 2 marked COMPLETED.
[INFO 11-21 20:41:04] ax.api.client: Generated new trial 3 with parameters {'x1': 7.139742, 'x2': -4.04316} using GenerationNode Sobol.
[INFO 11-21 20:41:04] ax.api.client: Trial 3 marked COMPLETED.
[INFO 11-21 20:41:04] ax.api.client: Generated new trial 4 with parameters {'x1': -8.801998, 'x2': 7.190593} using GenerationNode Sobol.
[INFO 11-21 20:41:04] ax.api.client: Trial 4 marked COMPLETED.
[INFO 11-21 20:41:05] ax.api.client: Generated new trial 5 with parameters {'x1': 5.284329, 'x2': 1.474437} using GenerationNode MBM.
[INFO 11-21 20:41:05] ax.api.client: Trial 5 marked COMPLETED.
[INFO 11-21 20:41:05] ax.api.client: Generated new trial 6 with parameters {'x1': 0.679507, 'x2': 4.076104} using GenerationNode MBM.
[INFO 11-21 20:41:05] ax.api.client: Trial 6 marked COMPLETED.
[INFO 11-21 20:41:05] ax.api.client: Generated new trial 7 with parameters {'x1': 1.461499, 'x2': 10.0} using GenerationNode MBM.
[INFO 11-21 20:41:05] ax.api.client: Trial 7 marked COMPLETED.
[INFO 11-21 20:41:06] ax.api.client: Generated new trial 8 with parameters {'x1': 1.081234, 'x2': 2.685163} using GenerationNode MBM.
[INFO 11-21 20:41:06] ax.api.client: Trial 8 marked COMPLETED.
[INFO 11-21 20:41:06] ax.api.client: Generated new trial 9 with parameters {'x1': -1.452378, 'x2': 3.541311} using GenerationNode MBM.
[INFO 11-21 20:41:06] ax.api.client: Trial 9 marked COMPLETED.`
}
</CellOutput>
...
<PlotlyFigure data={require('./assets/plot_data/881ad347-4ab3-41a7-b150-62934d693829.json')} />
...
<CellOutput>
{
`[INFO 11-21 20:41:10] ax.api.client: Generated new trial 10 with parameters {'x1': 10.0, 'x2': -10.0} using GenerationNode MBM.
[INFO 11-21 20:41:10] ax.api.client: Trial 10 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 11-21 20:41:10] ax.api.client: Generated new trial 11 with parameters {'x1': 10.0, 'x2': -2.390272} using GenerationNode MBM.
[INFO 11-21 20:41:10] ax.api.client: Trial 11 marked FAILED.
[INFO 11-21 20:41:10] ax.api.client: Generated new trial 12 with parameters {'x1': 10.0, 'x2': -2.497202} using GenerationNode MBM.
[INFO 11-21 20:41:10] ax.api.client: Trial 12 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
...
[INFO 11-21 20:41:11] ax.api.client: Generated new trial 13 with parameters {'x1': 0.444127, 'x2': 3.106754} using GenerationNode MBM.
[INFO 11-21 20:41:11] ax.api.client: Trial 13 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 11-21 20:41:11] ax.api.client: Generated new trial 14 with parameters {'x1': -10.0, 'x2': 0.475294} using GenerationNode MBM.
[INFO 11-21 20:41:11] ax.api.client: Trial 14 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 11-21 20:41:11] ax.api.client: Generated new trial 15 with parameters {'x1': 1.514131, 'x2': 3.050341} using GenerationNode MBM.
[INFO 11-21 20:41:11] ax.api.client: Trial 15 marked COMPLETED.
[INFO 11-21 20:41:11] ax.api.client: Generated new trial 16 with parameters {'x1': 10.0, 'x2': -7.789119} using GenerationNode MBM.
[INFO 11-21 20:41:11] ax.api.client: Trial 16 marked COMPLETED.
[INFO 11-21 20:41:12] ax.api.client: Generated new trial 17 with parameters {'x1': 1.888647, 'x2': 2.009847} using GenerationNode MBM.
[INFO 11-21 20:41:12] ax.api.client: Trial 17 marked COMPLETED.
[INFO 11-21 20:41:12] ax.api.client: Generated new trial 18 with parameters {'x1': 0.90961, 'x2': 3.114631} using GenerationNode MBM.
[INFO 11-21 20:41:12] ax.api.client: Trial 18 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.
[INFO 11-21 20:41:13] ax.api.client: Generated new trial 19 with parameters {'x1': 5.21478, 'x2': -10.0} using GenerationNode MBM.
[INFO 11-21 20:41:13] ax.api.client: Trial 19 marked ABANDONED. ABANDONED trials are not able to be re-suggested by get_next_trials.`
}
</CellOutput>
...
<PlotlyFigure data={require('./assets/plot_data/6b298074-b6e9-4df9-8320-4d193771d931.json')} />
