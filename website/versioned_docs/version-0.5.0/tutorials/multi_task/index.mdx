...
<LinkButtons
  githubUrl="https://github.com/facebook/ax/blob/0.5.0/tutorials/multi_task/multi_task.ipynb"
  colabUrl="https://colab.research.google.com/github/facebook/ax/blob/0.5.0/tutorials/multi_task/multi_task.ipynb"
/>
...
<CellOutput>
{
  `[INFO 02-03 18:47:25] ax.utils.notebook.plotting: Injecting Plotly library into cell. Do not overwrite or delete cell.`
}
</CellOutput>
...
<CellOutput>
{
  `[INFO 02-03 18:47:25] ax.utils.notebook.plotting: Please see
...
<PlotlyFigure data={require('./assets/plot_data/a2a33055-6dbf-48b6-95bc-eb3ab91c74b1.json')} />
...
<CellOutput>
{
  `Online-only batch 0 0.0033309459686279297`
}
</CellOutput>
...
<CellOutput>
{
  `Online-only batch 1 11.717747449874878`
}
</CellOutput>
...
<CellOutput>
{
  `Online-only batch 2 20.687729120254517`
}
</CellOutput>
...
<CellOutput>
{
  `Multi-task batch 0 0.007081747055053711`
}
</CellOutput>
...
<CellOutput>
{
  `/opt/hostedtoolcache/Python/3.12.8/x64/lib/python3.12/site-packages/linear_operator/utils/interpolation.py:71: UserWarning:
...
/opt/hostedtoolcache/Python/3.12.8/x64/lib/python3.12/site-packages/botorch/acquisition/logei.py:338: RuntimeWarning:
...
<CellOutput>
{
  `Multi-task batch 1 91.52688479423523`
}
</CellOutput>
...
<CellOutput>
{
  `Multi-task batch 2 191.7449963092804`
}
</CellOutput>
