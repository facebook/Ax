...
[8. Defining custom metrics](/docs/tutorials/gpei_hartmann_developer/#8-defining-custom-metrics).
...
[5. Perform Optimization](/docs/tutorials/gpei_hartmann_developer/#5-perform-optimization),
would otherwise not have data attached. This is necessary to get `objective_means` in
[7. Plot results](/docs/tutorials/gpei_hartmann_developer/#7-plot-results).
...
[6. Inspect trials' data](/docs/tutorials/gpei_hartmann_developer/#6-inspect-trials-data)
for more details.
