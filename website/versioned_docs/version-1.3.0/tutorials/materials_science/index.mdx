...
<CellOutput>
{
`[INFO 06-04 15:58:14] ax.storage.sqa_store.with_db_settings_base: Ax SQL storage initialized with SQLAlchemy 1.4.17`
}
</CellOutput>
...
<CellOutput>
{
`[INFO 06-04 15:58:14] ax.api.client: Trial 0 marked COMPLETED.
[INFO 06-04 15:58:14] ax.api.client: Trial 1 marked COMPLETED.
[INFO 06-04 15:58:14] ax.api.client: Trial 2 marked COMPLETED.
[INFO 06-04 15:58:14] ax.api.client: Trial 3 marked COMPLETED.
[INFO 06-04 15:58:14] ax.api.client: Trial 4 marked COMPLETED.
[INFO 06-04 15:58:14] ax.api.client: Trial 5 marked COMPLETED.`
}
</CellOutput>
...
[INFO 06-04 15:58:16] ax.api.client: Generated new trial 6 with parameters {'infill_density': 38.308167, 'layer_height': 0.343031, 'infill_type': 'rectilinear'} using GenerationNode Sobol.
[INFO 06-04 15:58:16] ax.api.client: Generated new trial 7 with parameters {'infill_density': 55.023998, 'layer_height': 0.204104, 'infill_type': 'honeycomb'} using GenerationNode MBM.
[INFO 06-04 15:58:16] ax.api.client: Generated new trial 8 with parameters {'infill_density': 3.459548, 'layer_height': 0.224133, 'infill_type': 'honeycomb'} using GenerationNode MBM.
{6: {'infill_density': 38.308167457580566,
  'layer_height': 0.34303061366081244,
  'infill_type': 'rectilinear'},
 7: {'infill_density': 55.02399779514087,
  'layer_height': 0.20410377838682522,
  'infill_type': 'honeycomb'},
 8: {'infill_density': 3.4595475398527973,
  'layer_height': 0.22413317955124484,
  'infill_type': 'honeycomb'}}`
}
</CellOutput>
...
<CellOutput>
{
`[INFO 06-04 15:58:16] ax.api.client: Trial 6 marked COMPLETED.
[INFO 06-04 15:58:16] ax.api.client: Trial 7 marked COMPLETED.
[INFO 06-04 15:58:16] ax.api.client: Trial 8 marked COMPLETED.`
}
</CellOutput>
...
<CellOutput>
{
`[INFO 06-04 15:58:20] ax.api.client: Generated new trial 9 with parameters {'infill_density': 42.322825, 'layer_height': 0.1, 'infill_type': 'honeycomb'} using GenerationNode MBM.
[INFO 06-04 15:58:20] ax.api.client: Generated new trial 10 with parameters {'infill_density': 77.900363, 'layer_height': 0.246026, 'infill_type': 'honeycomb'} using GenerationNode MBM.
[INFO 06-04 15:58:20] ax.api.client: Generated new trial 11 with parameters {'infill_density': 44.699622, 'layer_height': 0.1, 'infill_type': 'honeycomb'} using GenerationNode MBM.
{9: {'infill_density': 42.32282474201431,
  'layer_height': 0.1,
  'infill_type': 'honeycomb'},
 10: {'infill_density': 77.90036279230327,
  'layer_height': 0.24602573283047915,
  'infill_type': 'honeycomb'},
 11: {'infill_density': 44.699621819645905,
  'layer_height': 0.1,
  'infill_type': 'honeycomb'}}`
}
</CellOutput>
...
<CellOutput>
{
`[INFO 06-04 15:58:20] ax.api.client: Trial 9 marked COMPLETED.
[INFO 06-04 15:58:20] ax.api.client: Trial 10 marked COMPLETED.
[INFO 06-04 15:58:20] ax.api.client: Trial 11 marked COMPLETED.`
}
</CellOutput>
...
<CellOutput>
{
`[INFO 06-04 15:58:24] ax.api.client: Generated new trial 12 with parameters {'infill_density': 6.032256, 'layer_height': 0.1, 'infill_type': 'honeycomb'} using GenerationNode MBM.
[INFO 06-04 15:58:24] ax.api.client: Generated new trial 13 with parameters {'infill_density': 62.18965, 'layer_height': 0.1, 'infill_type': 'gyroid'} using GenerationNode MBM.
[INFO 06-04 15:58:24] ax.api.client: Generated new trial 14 with parameters {'infill_density': 100.0, 'layer_height': 0.371769, 'infill_type': 'honeycomb'} using GenerationNode MBM.
{12: {'infill_density': 6.032255987498587,
  'layer_height': 0.1,
  'infill_type': 'honeycomb'},
 13: {'infill_density': 62.18964960812253,
  'layer_height': 0.1,
  'infill_type': 'gyroid'},
 14: {'infill_density': 100.0,
  'layer_height': 0.37176872217849144,
  'infill_type': 'honeycomb'}}`
}
</CellOutput>
...
<CellOutput>
{
`[INFO 06-04 15:58:24] ax.api.client: Trial 12 marked COMPLETED.
[INFO 06-04 15:58:24] ax.api.client: Trial 13 marked COMPLETED.
[INFO 06-04 15:58:24] ax.api.client: Trial 14 marked COMPLETED.`
}
</CellOutput>
...
Prediction (mean, variance): {'weight': (np.float64(6.486305333107881), np.float64(0.3294408442161324)), 'compressive_strength': (np.float64(13.390991077578203), np.float64(1.3870972254663088))}`
}
</CellOutput>
...
<PlotlyFigure data={require('./assets/plot_data/ddaa0d56-b6f4-4581-a8fd-09e1edfacddc.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/a62c7a28-f776-4c6d-9208-43cf420a5dd8.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/b9506cdd-7971-49c3-bd27-8cebbe44f7c1.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/85bf14ac-44e7-4230-bbad-5d2f21bbb4b8.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/ecaea4b9-688a-421d-88e5-72b0bb94fb0a.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/3253b8aa-fcfb-4f81-b061-5eed026f859e.json')} />
...
|---:|--------------:|-----------:|:---------------|:------------------|-----------------------:|---------:|-----------------:|---------------:|:--------------|
|  0 |            13 |       13_0 | COMPLETED      | MBM               |                31.0948 |  9.32845 |          62.1897 |            0.1 | gyroid        |
...
|  6 |             6 |        6_0 | COMPLETED      | Sobol             |                2.23351 |  1.11676  |         38.3082  |       0.343031 | rectilinear   |
|  7 |             7 |        7_0 | COMPLETED      | MBM               |               26.9588  | 12.1315   |         55.024   |       0.204104 | honeycomb     |
|  8 |             8 |        8_0 | COMPLETED      | MBM               |                1.54352 |  0.694585 |          3.45955 |       0.224133 | honeycomb     |
|  9 |             9 |        9_0 | COMPLETED      | MBM               |               42.3228  | 19.0453   |         42.3228  |       0.1      | honeycomb     |
| 10 |            10 |       10_0 | COMPLETED      | MBM               |               31.6635  | 14.2486   |         77.9004  |       0.246026 | honeycomb     |
| 11 |            11 |       11_0 | COMPLETED      | MBM               |               44.6996  | 20.1148   |         44.6996  |       0.1      | honeycomb     |
| 12 |            12 |       12_0 | COMPLETED      | MBM               |                6.03226 |  2.71452  |          6.03226 |       0.1      | honeycomb     |
| 13 |            13 |       13_0 | COMPLETED      | MBM               |               31.0948  |  9.32845  |         62.1897  |       0.1      | gyroid        |
| 14 |            14 |       14_0 | COMPLETED      | MBM               |               26.8984  | 12.1043   |        100       |       0.371769 | honeycomb     |
...
<PlotlyFigure data={require('./assets/plot_data/9c3248a8-0ee6-41b4-848f-f6f2e5c629d8.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/da900542-642b-4c02-a7d9-5d2bb4da37a2.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/385d09f4-45e9-4325-a68d-59c3f92563ba.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/a2d4bf1f-9392-4279-ac4b-a30c4c73bd0f.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/11bdb83d-3a25-4f79-98b0-28ceeb0b0002.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/d32db6e0-1282-4443-a38b-45af3d26c1db.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/8aa50695-3b7d-4ed7-a447-764834f13136.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/a3b30594-7077-49e0-b257-2b10e87db843.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/b396f261-8f23-4f17-b742-5ec2091d3600.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/4732bfac-f1d7-4601-86ed-6cae4a9b5488.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/b97fe6aa-1fa6-454e-9701-a64fb4280b8a.json')} />


**Cross Validation for compressive_strength (R² = 0.91)**
...
<PlotlyFigure data={require('./assets/plot_data/66197c28-26e8-4bc2-bee4-f7968906f4f1.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/3ea6f927-accc-49f3-89af-b30344f8f5e9.json')} />
...
**Metric `compressive_strength` improved 1687.06%** from `1.74` in arm `'0_0'` to
`31.09` in arm `'13_0'`.
...
|---:|:---------------------|:---------|:--------------------------------------------------|
|  0 | compressive_strength | Improved | **Metric `compressive_strength` improved 1687.... |
