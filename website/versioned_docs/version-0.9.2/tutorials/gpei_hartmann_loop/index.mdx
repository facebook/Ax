...
<PlotlyFigure data={require('./assets/plot_data/875f5e90-1fee-4a6f-9464-595a30c90173.json')} />

```python
render(plot_contour(model=model, param_x="x1", param_y="x2", metric_name="l2norm"))
```

<PlotlyFigure data={require('./assets/plot_data/1a3aea4f-396e-46bb-a243-98cf068e311d.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/b4c575a6-86b2-4ccd-ae16-eb70ec4189a7.json')} />
