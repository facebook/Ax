...
<PlotlyFigure data={require('./assets/plot_data/8cab8a38-f5b6-4c8b-a821-e7a03470a08f.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/c8297737-e51c-4985-bf60-7edaa5e6c094.json')} />
