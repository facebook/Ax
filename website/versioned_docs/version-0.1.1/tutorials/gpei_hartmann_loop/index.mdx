...
<PlotlyFigure data={require('./assets/plot_data/59fe7384-d354-46ce-b3ce-d678c91b8260.json')} />

```python
render(plot_contour(model=model, param_x="x1", param_y="x2", metric_name="l2norm"))
```

<PlotlyFigure data={require('./assets/plot_data/17c61c0a-adde-4fd0-a254-080588f07b8f.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/603bffa8-de23-490d-bf67-5f62e93905f5.json')} />
