...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/scheduler/scheduler.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/scheduler/scheduler.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/ffb800a6-562a-4a8b-b705-5ce3373b220e.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/cd5fe4eb-da6c-4b1a-92ac-99705e6c23e4.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/d87761e8-b1c1-4ab2-b004-051af601264c.json')} />
