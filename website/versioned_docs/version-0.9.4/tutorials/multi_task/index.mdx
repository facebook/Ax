...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/multi_task/multi_task.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/multi_task/multi_task.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/4f41469b-04a3-41ab-924a-6213d36335b0.json')} />
