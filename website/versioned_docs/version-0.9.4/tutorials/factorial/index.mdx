...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/factorial/factorial.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/factorial/factorial.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/b35bd4bd-eb41-4e37-b2e8-2ee1d04256d6.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/0456c314-d02a-49bd-a4b0-de1ca41ec484.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/93f5cc94-1ca1-4b77-bfcd-a28b5522677e.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/1d43793e-704f-4a37-b63c-b92d0b22d388.json')} />
