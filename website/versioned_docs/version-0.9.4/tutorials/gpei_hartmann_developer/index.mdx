...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/gpei_hartmann_developer/gpei_hartmann_developer.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/gpei_hartmann_developer/gpei_hartmann_developer.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/b88ea30f-8b78-41a5-8cbe-fb63d0b9a217.json')} />
