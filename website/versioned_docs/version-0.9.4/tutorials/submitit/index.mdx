...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/submitit/submitit.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/submitit/submitit.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/682ac514-6b9f-4f87-8c76-5cea82fdc427.json')} />
