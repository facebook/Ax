...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/external_generation_node/external_generation_node.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/external_generation_node/external_generation_node.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/56d8d019-963b-497e-85fb-af86272411f5.json')} />
