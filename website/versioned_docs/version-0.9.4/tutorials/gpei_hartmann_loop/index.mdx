...
<LinkButtons
  githubUrl="https://github.com/cristianlara/Ax/blob/0.9.4/tutorials/gpei_hartmann_loop/gpei_hartmann_loop.ipynb"
  colabUrl="https://colab.research.google.com/github/cristianlara/Ax/blob/0.9.4/tutorials/gpei_hartmann_loop/gpei_hartmann_loop.ipynb"
/>
...
<PlotlyFigure data={require('./assets/plot_data/259f1f03-72cd-4642-be46-93ab3ca81064.json')} />

```python
render(plot_contour(model=model, param_x="x1", param_y="x2", metric_name="l2norm"))
```

<PlotlyFigure data={require('./assets/plot_data/48f497d8-b310-41dd-a64c-796d2f8e498b.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/52db0625-ac68-41b7-a26e-15d2961ce8d3.json')} />
