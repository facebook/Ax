...
class TestExternalGenerationNode(TestCase):
    ...
    def test_generation(self) -> None:
        ...
        self.assertEqual(gr._generator_key, "dummy")
    ...
    def test_fallback(self) -> None:
        ...
        with mock.patch(
            ...
            return_value=GeneratorRun(
                arms=[Arm(parameters=params)], generator_key="Sobol"
            ),
        ) as mock_gen:
        ...
        self.assertEqual(experiment.trials[0].generator_runs[0]._generator_key, "dummy")
        self.assertEqual(experiment.trials[1].generator_runs[0]._generator_key, "Sobol")
