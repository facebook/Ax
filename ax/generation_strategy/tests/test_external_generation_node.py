...
class TestExternalGenerationNode(TestCase):
    ...
    def test_should_skip_generation_returns_false_by_default(self) -> None:
        """Test that should_skip_generation returns False by default
        in the base ExternalGenerationNode class.
        """
        node = DummyNode()
        experiment = get_branin_experiment()
        self.assertFalse(node.should_skip_generation(experiment))
