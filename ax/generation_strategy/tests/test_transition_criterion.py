...
class TestTransitionCriterion(TestCase):
    ...
    def test_default_step_criterion_setup(self) -> None:
        ...
        step_1_expected_blocking_criteria = [
            MaxGenerationParallelism(
                threshold=1,
        ...
        self.assertEqual(
            gs._nodes[1].generation_blocking_criteria, step_1_expected_blocking_criteria
        )
        self.assertEqual(
...
class TestGenerationBlockingCriterion(TestCase):
    """Tests for new GenerationBlockingCriterion classes."""
