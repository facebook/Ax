...
class AuxiliaryExperimentCheck(TransitionCriterion):
    ...
    def block_continued_generation_error(
        ...
        """This method is not expected to be called since block_gen_if_met
        defaults to False for AuxiliaryExperimentCheck. The criterion is
        designed for transition logic, not generation blocking.
        """
        pass
