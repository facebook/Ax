...
@final
class EarlyStoppingHealthcheck(Analysis):
    """
    ...
    Status Logic:
    - PASS: Early stopping is functioning correctly OR no issues detected
    ...
    def compute(
        ...
        # Validation: Experiment is required
        if experiment is None:
            raise UserInputError("EarlyStoppingHealthcheck requires an Experiment.")
