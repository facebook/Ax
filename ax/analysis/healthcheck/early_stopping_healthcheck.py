...
class EarlyStoppingAnalysis(Analysis):
    ...
    Note on Multi-Objective and Constrained Experiments:
        ...
        single-objective unconstrained experiments, consistent with axsweep's
        behavior. If no strategy is provided for MOO/constrained experiments
        that have early stopped trials, this analysis will report a warning
        indicating that the original strategy should be provided.
    """
    ...
    def _report_early_stopping_status(
        ...
        """
        # Use provided strategy or use get_default_ess_or_none for consistency
        # with axsweep's default ESS configuration, which uses
    ...
    def _report_early_stopping_nudge(
        ...
        subtitle = (
            ...
            "optimization performance. See the Ax documentation for instructions "
            "on how to turn on early stopping."
        )
