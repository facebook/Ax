    ...
    def _check_search_space(
        ...
        if num_categorical_3_5 > 0:
            ...
            if num_categorical_3_5 > 5:
                is_supported = False
                why_not_supported.append(
                    f"{num_categorical_3_5} unordered choice parameters with "
                    "3-5 options (max supported is 5)"
                )
        ...
        if num_categorical_6_inf > 0:
            ...
            if num_categorical_6_inf > 1:
                is_supported = False
                why_not_supported.append(
                    f"{num_categorical_6_inf} unordered choice parameters with "
                    "6+ options (max supported is 1)"
                )
