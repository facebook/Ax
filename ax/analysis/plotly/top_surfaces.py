...
class TopSurfacesAnalysis(Analysis):
    def __init__(
        ...
        """
        Args:
            metric_name: The metric to analyze. If None, uses the objective.
            order: Sobol index order ("first", "second", or "total").
            top_k: Number of top-sensitivity parameters to include in
                slice/contour plots.
            relativize: Whether to relativize effects against the status quo.
            labels: Optional mapping from metric name to display label,
                used internally by InsightsAnalysis to show human-readable
                names for preference metrics (e.g., "Learned Preference
                Utility" instead of "pairwise_pref_query"). Not intended
                for direct user use — auto-generated by the analysis layer.
        """
