...
class Acquisition(Base):
    ...
    **All classes in 'botorch_modular' directory are under
    ...
    def __init__(
        ...
        self._target_point = torch_opt_config.target_point
    ...
    def optimize(
        ...
        if self.options.get("prune_irrelevant_parameters", False):
            ...
            if self._target_point is None:
                logger.warning(
                    "Must specify target_point to prune irrelevant parameters. "
                    "Skipping pruning irrelevant parameters."
                )
            else:
    ...
    def _prune_irrelevant_parameters(
        ...
        """
        target_point = none_throws(self._target_point)
