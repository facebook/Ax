...
import ax.generators.torch.botorch_moo_defaults as botorch_moo_defaults
...
from ax.generators.torch.utils import HYPERSPHERE
...
SAMPLE_SIMPLEX_UTIL_PATH = "ax.generators.torch.utils.sample_simplex"
SAMPLE_HYPERSPHERE_UTIL_PATH = "ax.generators.torch.utils.sample_hypersphere"
CHEBYSHEV_SCALARIZATION_PATH = (
    "ax.generators.torch.botorch_defaults.get_chebyshev_scalarization"
)
NEHVI_ACQF_PATH = (
...
class BotorchMOOModelTest(TestCase):
    ...
    def test_BotorchMOOModel_with_chebyshev_scalarization(
        ...
        with mock.patch(
            ...
            "ax.generators.torch.botorch_moo_defaults.optimize_acqf_list",
    ...
    def test_BotorchMOOModel_with_qehvi(
        ...
        with ExitStack() as es:
            ...
            _mock_model_infer_objective_thresholds = es.enter_context(
                mock.patch(
                    "ax.generators.torch.botorch_moo.infer_objective_thresholds",
                    wraps=infer_objective_thresholds,
                )
            )
            _mock_infer_reference_point = es.enter_context(
                mock.patch(
                    "ax.generators.torch.botorch_moo_defaults.infer_reference_point",
