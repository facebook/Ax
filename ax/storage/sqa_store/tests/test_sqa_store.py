...
from ax.storage.json_store.decoder import (
    generation_blocking_criterion_from_json,
...
class SQAStoreTest(TestCase):
    ...
    def test_transition_criterion_deserialize_with_extra_fields(self) -> None:
        ...
        MaxGenerationParallelism, which is now a GenerationBlockingCriterion.
        ...
        # Note: MaxGenerationParallelism is now a GenerationBlockingCriterion,
        # so we use generation_blocking_criterion_from_json.
        criterion = assert_is_instance(
            generation_blocking_criterion_from_json(
                blocking_criterion_class=MaxGenerationParallelism,
    ...
    def test_gen_node_deserialize_with_tc_transition_to_none(
        ...
        should automatically migrate it to generation_blocking_criteria.
        """
        ...
        # transition_criteria to generation_blocking_criteria
        self.assertEqual(len(node.transition_criteria), 0)
        self.assertEqual(len(node.generation_blocking_criteria), 1)
        criterion = assert_is_instance(
            node.generation_blocking_criteria[0],
            MaxGenerationParallelism,
        )
    ...
    def test_block_gen_if_met_mintrials_migration(self) -> None:
        ...
        self.assertEqual(node.name, "test_node")
        # Should have both, one to represent the blocking criterion and
        ...
        blocking = assert_is_instance(
            node.generation_blocking_criteria[0], MaxTrialsAwaitingData
        )
