...
def generation_node_to_dict(generation_node: GenerationNode) -> dict[str, Any]:
    ...
    return {
        ...
        "generation_blocking_criteria": generation_node.generation_blocking_criteria,
...
def generation_blocking_criterion_to_dict(
    criterion: GenerationBlockingCriterion,
) -> dict[str, Any]:
    """Convert Ax GenerationBlockingCriterion to a dictionary."""
    properties = serialize_init_args(obj=criterion)
    properties["__type"] = criterion.__class__.__name__
    return properties
