...
class JSONStoreTest(TestCase):
    ...
    def test_block_gen_if_met_migration(self) -> None:
        ...
        to GenerationBlockingCriterion during deserialization."""
        with self.subTest("MaxGenerationParallelism_with_block_gen_if_met"):
            ...
            # migrated to generation_blocking_criteria and removed from
            # transition_criteria
            json = {
                "node_name": "test_node",
                "model_specs": [
            ...
            blocking = node.generation_blocking_criteria[0]
