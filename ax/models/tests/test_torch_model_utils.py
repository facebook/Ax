...
class TorchUtilsTest(TestCase):
    ...
    def testSubsetModel(self):
        ...
        model_sub, obj_weights_sub, Ys_sub, ocs_sub = subset_model(
            model, obj_weights, Ys
        )
        ...
        model_sub, obj_weights_sub, Ys_sub, ocs = subset_model(model, obj_weights, Ys)
        ...
        with self.assertRaises(RuntimeError):
            subset_model(model, obj_weights, Ys)
