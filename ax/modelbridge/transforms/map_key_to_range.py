...
from ax.modelbridge.transforms.metadata_to_range import _transfer, MetadataToRange
...
class MapKeyToRange(MetadataToRange):
    ...
    def __init__(
        ...
        self.parameters.setdefault(self.DEFAULT_MAP_KEY, {}).update(log_scale=True)
        super().__init__(
