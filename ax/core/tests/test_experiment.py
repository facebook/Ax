...
class ExperimentWithMapDataTest(TestCase):
    ...
    def test_is_preference_learning_problem(self) -> None:
        """Test the is_preference_learning_problem property."""

        with self.subTest("No preference indicators"):
            experiment = get_branin_experiment()
            self.assertFalse(experiment.is_preference_learning_problem)
        ...
        with self.subTest("Has PreferenceOptimizationConfig"):
            ...
            self.assertTrue(experiment.is_preference_learning_problem)
