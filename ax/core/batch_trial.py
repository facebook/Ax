...
class BatchTrial(BaseTrial):
    ...
    *deployed and evaluated together*, and possibly arm weights, which are
    ...
    @property
    def _status_quo(self) -> Arm | None:
        """Raises a DeprecationWarning and redirects to Experiment.status_quo."""
        warnings.warn(
            "BatchTrial._status_quo is deprecated. "
            "Please use `Experiment.status_quo` instead.",
            DeprecationWarning,
            stacklevel=2,
        )
