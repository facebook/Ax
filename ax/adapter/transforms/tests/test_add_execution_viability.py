...
class TestAddExecutionViability(TestCase):
    ...
    def test_transform_experiment_data(self) -> None:
        ...
        # Assert: Verify execution_viable metric was added
        ...
        for abandoned_trial in abandoned_trials:
            ...
            feasibility_value = transformed_data.observation_data.loc[
                (trial_idx, slice(None)), ("mean", "execution_viable")
            ].iloc[0]
            self.assertEqual(
                feasibility_value,
                0.0,
                f"Abandoned trial {trial_idx} should have execution_viable of 0.0",
            )

        # Verify completed trials have execution_viable of 1.0
        completed_trials = [
            trial
        ...
        for trial in completed_trials:
            ...
            self.assertEqual(
                feasibility_value,
                1.0,
                f"Non-abandoned trial {trial_idx} should have execution_viable of 1.0",
            )
