...
class BaseAdapterTest(TestCase):
    def test_init_empty(self) -> None:
        ...
        self.assertEqual(adapter._training_in_design, [])
    ...
    def test_init_with_data(self, multi_objective: bool = False) -> None:
        ...
        self.assertEqual(adapter._training_in_design, [True] * len(exp.arms_by_name))
        self.assertEqual(adapter._optimization_config, exp.optimization_config)
    ...
    def test_init_with_data_multi_objective(self) -> None:
        self.test_init_with_data(multi_objective=True)
