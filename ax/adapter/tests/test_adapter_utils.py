...
class TestAdapterUtils(TestCase):
    ...
    def test_extract_target_point(self) -> None:
        ...
        actual = extract_target_point(target_arm, parameters)
    ...
    def test_extract_target_point_different_parameter_order(self) -> None:
