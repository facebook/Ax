...
class TestDataUtils(TestCase):
    ...
    def test_extract_experiment_data_multiple_map(self) -> None:
        ...
        data_df.loc[data_df["metric_signature"] == "tracking_branin_map", MAP_KEY] += (
            1000
        )
        ...
        expected_mean_df = DataFrame(
            [
                {"branin_map": t_0_metric, "tracking_branin_map": t_0_metric},  # t=0
                {"branin_map": t_0_metric, "tracking_branin_map": t_0_metric},  # t=1
                {"branin_map": t_0_metric, "tracking_branin_map": t_0_metric},  # t=2
                {"branin_map": t_0_metric, "tracking_branin_map": t_0_metric},  # t=3
                {"branin_map": t_1_metric, "tracking_branin_map": t_1_metric},  # t=0
                {"branin_map": t_1_metric, "tracking_branin_map": t_1_metric},  # t=1
            ],
            index=index,
        )
        self.assertTrue(
