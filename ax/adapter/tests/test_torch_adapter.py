...
class TorchAdapterTest(TestCase):
    ...
    def test_convert_observations(self) -> None:
        ...
        for use_task, expected_class in (
            ...
            converted_datasets, ordered_outcomes, _ = adapter._convert_observations(
            ...
            with self.assertRaisesRegex(DataRequiredError, "no data for extra"):
                adapter._convert_observations(
                    experiment_data=experiment_data,
