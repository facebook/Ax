...
class AxOrchestratorTestCase(TestCase):
    """Tests base `Orchestrator` functionality.  This test case is meant to
    test Orchestrator using `GenerationStrategy`, but be extensible so
    ...
    IMPORTANT! Any class that inherits from AxOrchestratorTestCase will automatically
    ...
    def test_init_with_branin_experiment(self) -> None:
        ...
        self.assertEqual(orchestrator.generation_strategy, rgs)
    ...
    def test_global_stopping(self) -> None:
        ...
        self.assertIsNotNone(orchestrator.options.global_stopping_strategy)
        ess = orchestrator.options.global_stopping_strategy
        self.assertEqual(
            ess.estimate_global_stopping_savings(
    ...
    def test_standard_generation_strategy(self) -> None:
        with self.subTest("with a `GenerationStrategy"):
            ...
            self.assertEqual(
                orchestrator.standard_generation_strategy, self.sobol_MBM_GS
            )
    ...
    def test_get_improvement_over_baseline(self) -> None:
        ...
        percent_improvement = orchestrator.get_improvement_over_baseline(
            ...
            generation_strategy=orchestrator.standard_generation_strategy,
    ...
    def test_it_works_with_multitask_models(
        ...
        self.assertTrue(orchestrator.standard_generation_strategy.optimization_complete)
