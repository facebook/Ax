...
def _compute_utility_from_preference_model(
    ...
    # Create ObservationFeatures for each arm and transform to model space
    # This ensures proper metric ordering and applies any necessary transforms
    ...
    # Transform observation features to model space tensor
    # This handles metric ordering and applies adapter transforms
    X = adapter.transform_observation_features(observation_features)
