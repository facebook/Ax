...
from ae.lazarus.ae.generator.array import FIT_MODEL_ERROR, ArrayGenerator
from ae.lazarus.ae.generator.transforms.base import Transform
from ae.lazarus.ae.models.torch_base import TorchModel
from torch import Tensor


class TorchGenerator(ArrayGenerator):
    """A model generator for using torch-based models.
