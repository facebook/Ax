...
class NumpyGeneratorTest(TestCase):
    def setUp(self):
        self.parameters = [
    ...
    @mock.patch(
        "ae.lazarus.ae.generator.numpy.NumpyGenerator.__init__", return_value=None
    )
    ...
    @mock.patch(
        "ae.lazarus.ae.generator.numpy.NumpyGenerator._model_predict",
        return_value=(
    ...
    @mock.patch(
        "ae.lazarus.ae.generator.numpy.NumpyGenerator._model_gen",
        autospec=True,
        return_value=(
    ...
    @mock.patch(
        "ae.lazarus.ae.generator.numpy.NumpyGenerator._model_best_point",
        autospec=True,
        return_value=None,
    )
    @mock.patch(
    ...
    @mock.patch(
        "ae.lazarus.ae.generator.numpy.NumpyGenerator._model_cross_validate",
        return_value=(
            np.array([[1.0, -1], [2.0, -2]]),
            np.stack(
                (np.array([[1.0, 4.0], [4.0, 6]]), np.array([[2.0, 5.0], [5.0, 7]]))
