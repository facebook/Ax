...
from ae.lazarus.ae.generator.discrete import DiscreteGenerator, _get_parameter_values
...
class DiscreteGeneratorTest(TestCase):
    ...
    @mock.patch(
        "ae.lazarus.ae.generator.discrete.DiscreteGenerator.__init__", return_value=None
    )
