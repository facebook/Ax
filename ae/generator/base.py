...
from ae.lazarus.ae.core.types.types import TConfig, TModelCov, TModelMean, TModelPredict
...
class Generator(ABC):
    """The main object for using models in AE. Generator specifies 2 methods
    for using models:
