...
from ae.lazarus.ae.core.parameter import ChoiceParameter, ParameterType
...
class BatchAsTask(Transform):
    ...
    def __init__(
        ...
        if config is not None and "trial_level_map" in config:
            # pyre: Attribute `trial_level_map` declared in class `ae.lazarus.ae.
            # pyre: generator.transforms.trial_as_task.BatchAsTask` has type
