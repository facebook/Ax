...
from ae.lazarus.ae.modelbridge.base import (
    ModelBridge,
    gen_arms,
...
class BaseModelBridgeTest(TestCase):
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.base.observations_from_data",
        autospec=True,
        return_value=([observation1(), observation2()]),
    )
    @mock.patch(
        "ae.lazarus.ae.modelbridge.base.unwrap_observation_data",
        autospec=True,
        return_value=(2, 2),
    )
    @mock.patch(
        "ae.lazarus.ae.modelbridge.base.gen_arms",
        autospec=True,
        return_value=[Arm(params={})],
    )
    @mock.patch("ae.lazarus.ae.modelbridge.base.ModelBridge._fit", autospec=True)
    def testModelBridge(
        self,
        mock_fit,
        mock_gen_arms,
        ...
        modelbridge._predict = mock.MagicMock(
            "ae.lazarus.ae.modelbridge.base.ModelBridge._predict",
            autospec=True,
        ...
        modelbridge._gen = mock.MagicMock(
            "ae.lazarus.ae.modelbridge.base.ModelBridge._gen",
            autospec=True,
        ...
        modelbridge._cross_validate = mock.MagicMock(
            "ae.lazarus.ae.modelbridge.base.ModelBridge._cross_validate",
            autospec=True,
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.base.ModelBridge.predict",
        autospec=True,
        return_value=None,
    )
