...
from ae.lazarus.ae.modelbridge.cross_validation import (
    CVResult,
    compute_diagnostics,
    cross_validate,
)
...
class CrossValidationTest(TestCase):
    ...
    def testCrossValidate(self):
        ...
        ma.get_training_data = mock.MagicMock(
            "ae.lazarus.ae.modelbridge.base.ModelBridge.get_training_data",
            autospec=True,
            return_value=self.training_data,
        )
        ma.cross_validate = mock.MagicMock(
            "ae.lazarus.ae.modelbridge.base.ModelBridge.cross_validate",
            autospec=True,
