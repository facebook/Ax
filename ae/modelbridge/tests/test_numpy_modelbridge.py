...
from ae.lazarus.ae.modelbridge.modelbridge_utils import get_bounds_and_task
...
class NumpyModelBridgeTest(TestCase):
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.numpy.NumpyModelBridge.__init__", return_value=None
    )
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.numpy.NumpyModelBridge._model_predict",
        return_value=(
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.numpy.NumpyModelBridge._model_gen",
        autospec=True,
        return_value=(
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.numpy.NumpyModelBridge._model_best_point",
        autospec=True,
        return_value=None,
    )
    @mock.patch(
    ...
    @mock.patch(
        "ae.lazarus.ae.modelbridge.numpy.NumpyModelBridge._model_cross_validate",
        return_value=(
            np.array([[1.0, -1], [2.0, -2]]),
            np.stack(
                (np.array([[1.0, 4.0], [4.0, 6]]), np.array([[2.0, 5.0], [5.0, 7]]))
