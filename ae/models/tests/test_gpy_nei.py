...
from ae.lazarus.ae.models.numpy.gpy_nei import (
...
class GPyModelTest(TestCase):
    ...
    @mock.patch("ae.lazarus.ae.models.numpy.gpy_nei.nei_vectorized", autospec=True)
    @mock.patch("ae.lazarus.ae.models.numpy.gpy_nei.SobolEngine", autospec=True)
    ...
    @mock.patch(
        "ae.lazarus.ae.models.numpy.gpy_nei.minimize", side_effect=StopIteration
    )
    @mock.patch(
        "ae.lazarus.ae.models.numpy.gpy_nei.objective_and_grad",
        autospec=True,
        return_value=(1, 2),
    )
    ...
    @mock.patch(
        "ae.lazarus.ae.models.numpy.gpy_nei.nei_and_grad",
        autospec=True,
