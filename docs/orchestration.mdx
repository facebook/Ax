---
id: orchestration
title: Internal Organization of Ax -- Orchestration
---
...
# Internal Organization of Ax -- Orchestration

Orchestrating adaptive experiments can get arbitrarily complex. Key
...
[Internal Organization of Ax -- Experiment](./experiment).
...
<center><img src={orchestrator_loop} alt="The Orchestrator's basic loop" width="60%" /></center>
...
Orchestration is available via the API (see
[Automating Optimization](../tutorials/automating)). The `Runner` and `Metric`
