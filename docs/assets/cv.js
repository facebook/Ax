...
function getPlotData() {
  ...
  {'type': 'scatter',
   ...
   'mode': 'markers',
   'name': 'In-sample',
   'text': ['<b>Arm 0_0</b><br><br>Actual Outcome: 24.13 [20.210, 28.050]<br>Predicted Outcome: 23.832 [19.052, 28.612]<br><br><em>Parameterization:</em><br>x1: 2.5<br>x2: 7.5',
 ...
 'layout': {'annotations': [{'showarrow': false,
  ...
  'updatemenus': [{'x': 0,
    ...
    'buttons': [{'args': ['visible', [true, true]],
      'label': 'metric_a',
      'method': 'restyle'}]},
   {'buttons': [{'args': [{'error_x.width': 4,
        'error_x.thickness': 2,
        'error_y.width': 4,
        'error_y.thickness': 2}],
      'label': 'Yes',
      'method': 'restyle'},
     {'args': [{'error_x.width': 0,
        'error_x.thickness': 0,
        'error_y.width': 0,
        'error_y.thickness': 0}],
      'label': 'No',
