...
function getPlotData() {
  const data = {'data': [{'type': 'scatter',
   ...
   'mode': 'markers',
   'name': 'In-sample',
   'text': ['<b>Arm 0_0</b><br><br>metric_a: 24.01 [20.979, 27.041]<br><br><em>Parameterization:</em><br>x1: 2.5<br>x2: 7.5',
 ...
 'layout': {
  ...
  'updatemenus': [{'x': 1.25,
    'y': 0.67,
    'buttons': [{'args': [{'xaxis.categoryorder': 'array',
        'xaxis.categoryarray': ['0_0',
         '0_1',
         '0_2',
         '0_3',
         '0_4',
