...
An experiment consists of a sequence of trials, each of which evaluates one or more arms. For more details on  implementing the evaluation, see the documentation for [runner](runner.md) and [metric](metric.md).
